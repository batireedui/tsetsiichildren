                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="/sign-in-do" method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">Email хаягаа оруулна уу</label>
                                <input type="text" class="form-control" id="email" name="email" />
                                <input type="text" name="role" value="najiltan" style="display: none;" />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                <div class="d-flex justify-content-between">
                                    <label class="form-label" for="password">Нууц үгээ оруулна уу</label>
                                    <a href="/recovery?role=najiltan">
