                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            "mRender": function(data) {
                                ...
                                return '<div class="dropdown"><button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button><div class="dropdown-menu"><a class="dropdown-item" onclick="edit(' + data.student_id + ', ' + data.school_id + ', 0)"><i class="bx bx-edit-alt me-1"></i> Засварлах</a><a class="dropdown-item" onclick="shilj(' + data.student_id + ', ' + data.school_id + ')"><i class="bx bx-note me-1"></i> Шилжилт</a></div></div>';
                            }
                        }
                    ],
