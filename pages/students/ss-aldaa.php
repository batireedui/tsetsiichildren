...
$sql = " WHERE students.school_id != 0 and students.angi_id = 0";
if ($_SESSION['user_role'] == "najiltan") {
    $sql = " WHERE students.school_id = ".$_SESSION['school_id']." and students.angi_id = 0";
}

elseif ($_SESSION['user_role'] == "teacher") {
    $sql = " WHERE students.school_id = ".$_SESSION['school_id']." and angis.teacher_id = ".$_SESSION['user_id'];
}
...
$sql = "SELECT students.id as student_id, fname, lname, students.phone, gender, rd, schools.school_name, schools.id as school_id FROM students INNER JOIN schools ON students.school_id = schools.id " . $sql;    
$table = <<<EOT
( $sql ) temp
EOT;
