...
<div class="layout-page">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card" style="padding: 20px;">
            ...
            <?php unset($_SESSION['action']); endif;?>
            <div class="row gy-3">
                <!-- Default Modal -->
                <div class="col-lg-6 col-sm-12">
                    <div class="col-sm-6:eq(0)"></div>
                    <h4 class="fw-bold py-3 mb-4">Шалгуур үзүүлэлтийн бүртгэл (<?= $count ?>)</h4>
                </div>
                        ...
                        <?php if ($count > 0) : ?>
                            ...
                            foreach ($bulegs as $buleg) {
                                _select(
                                    $sstmt,
                                    $scount,
                                    "SELECT id, name, ded, turul, hariulttype FROM shalguurs WHERE buleg_id=?",
                                    "i",
                                    [$buleg[0]],
                                    $sid,
                                    $sname,
                            ...
                            ?>
                                <tr>
                                    <td colspan="4" id="b1-<?= $buleg[0] ?>"><b><?= $buleg[1] ?></b></td>
                                    <td>
                                        <div class="dropdown">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td id="f2-<?= $sid ?>" data-tid="<?= $id ?>"><?php echo $sturul == 0 ? "<div class='btn rounded-pill me-2 btn-outline-info'>Тийм/Үгүй</div>" : "<div class='btn rounded-pill me-2 btn-outline-warning'>Олон сонголт</div>"?></td>
                                        <td id="f3-<?= $sid ?>"><?php echo $sded == 0 ? "<div class='btn rounded-pill me-2 btn-outline-primary'>Задаргаагүй</div>" : "<div class='btn rounded-pill me-2 btn-outline-secondary'>Задаргаатай ($hval)</div>" ?></td>
                                        <td>
                                            <div class="dropdown">
                                                <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                                    <i class="bx bx-dots-vertical-rounded"></i>
